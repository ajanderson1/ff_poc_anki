---
description: Create a Swedish phrase/expression Anki flashcard with audio
---

You are tasked with creating an Anki card for the given Swedish phrase or expression.
...
Create an Anki card in the deck "Swedish::Phrases" for this phrase.
...
2. **Define and translate the phrase** - First, create a Swedish explanation/definition of the phrase using synonyms or brief descriptions. Then translate the phrase to English in the most natural way possible. If it's an expression where there are multiple common ways of expressing it, include both.
3. **Create the Anki card** - Use `mcp__anki-mcp__create_note` with:
   - deck_name: "Swedish::Phrases"
...
- Decide CEFR listening difficulty roughly based on how frequent and basic the phrase is in daily spoken Swedish.
...
1. **phrase:** [the Swedish phrase, lowercase]

2. **pronunciation:** [friendly respelling]

3. **meaning:** [Swedish explanation/definition of the phrase] - Provide a concise explanation in Swedish of what the phrase means, using synonyms or brief descriptions to assist with understanding. This should help learners grasp the meaning in Swedish before seeing the English translation.
...
5. **usage_notes:** [Pertinent notes in English on how it is used, anything to be careful/aware of, etc.] Include notes about formality level, regional variations, or situations where this phrase is particularly appropriate.
