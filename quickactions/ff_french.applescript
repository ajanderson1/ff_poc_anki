(*
    ...
    It receives selected text and passes it to ff_flashcard.sh with --lang=fr,
...
on run {input, parameters}
    try
        ...
        -- Build the shell command with --lang=fr and proper quoting
        set shellCommand to quoted form of scriptPath & " --lang=fr " & quoted form of targetText
